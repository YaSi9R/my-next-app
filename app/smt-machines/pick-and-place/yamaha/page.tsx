        ...
        <div className="min-h-screen bg-[#e6e6e6] py-12">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="text-sm text-gray-600 mb-6">
                    ...
                    <Link href="/smt-machines" className="hover:text-[#022c75]">SMT Machines</Link>
                    <span className="mx-2">/</span>
                    <Link href="/smt-machines/pick-and-place" className="hover:text-[#022c75]">Pick & Place</Link>
                    <span className="mx-2">/</span>
                    <span className="text-[#022c75] font-semibold">Yamaha</span>
                </div>
                    ...
                    {yamahaProducts.map((product) => (
                        ...
                        >
                            ...
                            <div className="relative h-64 bg-gradient-to-br from-blue-50 to-gray-100 flex items-center justify-center overflow-hidden">
                                <div className="absolute inset-0 bg-[#022c75] opacity-0 group-hover:opacity-10 transition-opacity"></div>
