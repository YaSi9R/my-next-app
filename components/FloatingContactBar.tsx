    ...
    return (
        <>
            ...
            <div className="hidden md:flex fixed right-0 top-1/2 -translate-y-1/2 z-50 flex-col bg-red-600 shadow-lg" style={{ borderTopLeftRadius: '4px', borderBottomLeftRadius: '4px' }}>
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 hover:bg-red-700 transition-colors border-b border-white/20 ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
                ...
                {/* Chat (to chatbot) */}
                <Link href="/chatbot" className="flex items-center justify-center w-12 h-12 hover:bg-red-700 transition-colors border-b border-white/20">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
                ...
                {/* Mail */}
                <a href="mailto:info@example.com" className="flex items-center justify-center w-12 h-12 hover:bg-red-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
