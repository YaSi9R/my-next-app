    ...
    return (
        <>
            ...
            <div className="hidden md:flex fixed right-0 top-1/2 -translate-y-1/2 z-50 flex-col bg-[#e6e6e6] shadow-lg border border-gray-200" style={{ borderTopLeftRadius: '4px', borderBottomLeftRadius: '4px' }}>
                ...
                {/* IndiaMART */}
                <a href="https://www.indiamart.com/tekmartindiaexim/profile.html?srsltid=AfmBOoqE7E12McyVreF6noBX-V2AJUP3CTLXa1hamVfp8_yCfTBGwkV-" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 hover:bg-[#e6e6e6] group transition-colors border-b border-gray-100">
                    <div className="w-10 h-10 relative group-hover:scale-110 transition-transform">
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-[100] bg-[#e6e6e6] border-t border-gray-100 shadow-[0_-5px_15px_rgba(0,0,0,0.1)] pb-[env(safe-area-inset-bottom,16px)]">
                <div className="grid grid-cols-5 h-14 relative z-[101]">
                    ...
                    <a href="tel:+919220246692" className="flex flex-col items-center justify-center h-full hover:bg-gray-50 transition-colors group">
                        <FaPhoneAlt className="w-8 h-8 text-[#022c75] group-hover:scale-110 transition-transform" />
                    ...
                    {/* IndiaMART */}
                    <a href="https://www.indiamart.com/tekmartindiaexim/profile.html?srsltid=AfmBOoqE7E12McyVreF6noBX-V2AJUP3CTLXa1hamVfp8_yCfTBGwkV-" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center h-full hover:bg-gray-50 transition-colors group">
                        <div className="w-8 h-8 relative group-hover:scale-110 transition-transform">
                            <Image src={indiamartlog} alt="IndiaMART" fill className="object-contain" />
                        </div>
