...
const ProductsSection = () => {
    return (
        <section className="py-20 px-4 bg-[#e6e6e6] ">
            <div className="container mx-auto max-w-7xl">
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#022c75] group">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-2xl font-bold text-[#022c75] mb-3">SMT Machine</h3>
                                    ...
                                    <Link href="/products" className="inline-flex items-center gap-2 text-[#022c75] font-semibold hover:gap-3 transition-all">
                                        Learn More
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#022c75] group">
                                <div className="space-y-4">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#022c75]">SMT Parts</h3>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#022c75] group">
                                <div className="space-y-4">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#022c75]">SMT Production Line</h3>
                                    <p className="text-gray-600 leading-relaxed">
