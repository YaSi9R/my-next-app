...
const ContactSection = () => {
    return (
        <div className="w-full bg-[#022c75]">
            {/* CTA Banner */}
            ...
            <section className="relative py-24 min-h-screen flex items-center overflow-hidden" style={{ clipPath: 'inset(0)' }}>
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-[#022c75]/80 max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-1 space-y-8">
                            <div className="bg-[#e6e6e6] backdrop-blur-md p-8 rounded-2xl shadow-sm border border-[#e6e6e6]/20 flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-[#e6e6e6]/10 flex items-center justify-center flex-shrink-0">
                                    <MapPin size={24} className="text-[#022c75]" />
                                </div>
                                <div>
                                    <h4 className="font-bold text-[#022c75] mb-1">Our Location</h4>
                                    <p className="text-[#022c75]/70 text-sm">Industrial Zone A, New Delhi, India</p>
                                </div>
                            </div>
                            <div className="bg-[#e6e6e6] backdrop-blur-md p-8 rounded-2xl shadow-sm border border-[#e6e6e6]/20 flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-[#e6e6e6]/10 flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#022c75]/70 text-sm">+91 1234 567 890</p>
                                    <p className="text-[#022c75]/70 text-sm">Mon-Fri: 9:00 AM - 6:00 PM</p>
                                </div>
                            </div>
                            <div className="bg-[#e6e6e6] backdrop-blur-md p-8 rounded-2xl shadow-sm border border-[#e6e6e6]/20 flex items-start gap-4">
                                <div className="w-12 h-12 rounded-full bg-[#e6e6e6]/10 flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#022c75]/70 text-sm">sales@tekmart.com</p>
                                    <p className="text-[#022c75]/70 text-sm">support@tekmart.com</p>
                                </div>
                            </div>
                        </div>
                        {/* Form */}
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-6 text-[#022c75] py-4 rounded-xl border border-gray-200 focus:border-[#e6e6e6] focus:ring-2 focus:ring-[#e6e6e6]/20 transition-all outline-none bg-[#022c75]/20"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-6 py-4 text-[#022c75] rounded-xl border border-gray-200 focus:border-[#e6e6e6] focus:ring-2 focus:ring-[#e6e6e6]/20 transition-all outline-none bg-[#022c75]/20"
                                        />
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <select className="w-full text-[#022c75] px-6 py-4 rounded-xl border border-gray-200 focus:border-[#e6e6e6] focus:ring-2 focus:ring-[#e6e6e6]/20 transition-all outline-none bg-[#022c75]/20 appearance-none">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full text-[#022c75] px-6 py-4 rounded-xl border border-gray-200 focus:border-[#e6e6e6] focus:ring-2 focus:ring-[#e6e6e6]/20 transition-all outline-none bg-[#022c75]/20 resize-none"
                                    ></textarea>
                                </div>
